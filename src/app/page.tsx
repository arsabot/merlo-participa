...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 pb-20">
      ...
      {/* 1. HERO PRINCIPAL */}
      <section className="relative overflow-hidden bg-gradient-to-b from-sky-100/50 via-[#F8FAFC] to-[#F8FAFC] pt-12 sm:pt-20 pb-16 border-b border-sky-100/80">
        
        {/* Background glow accents */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-r from-sky-900/10 via-[#0B4F8A]/10 to-blue-800/10 blur-3xl -z-10 pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-100/80 text-[#0B4F8A] text-xs font-bold border border-sky-200 shadow-sm animate-fade-in">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#0F172A] tracking-tight leading-[1.1]">
                ...
                <span className="bg-gradient-to-r from-[#0B4F8A] via-[#0284C7] to-[#0B4F8A] bg-clip-text text-transparent">
                  Hagámosla escuchar.
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 pt-2">
                <Link
                  href="/reclamos/nuevo"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold text-base text-white bg-[#0B4F8A] hover:bg-[#072C4F] shadow-lg shadow-sky-950/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
                >
                ...
                <Link
                  href="/reclamos"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold text-base text-[#0B4F8A] bg-white border-2 border-sky-200 hover:border-[#0B4F8A] hover:bg-sky-50/50 shadow-sm transition-all"
                >
                  <Search className="w-5 h-5 text-[#0B4F8A]" />
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-md bg-white/95 backdrop-blur-xl rounded-3xl p-6 sm:p-7 border border-[#E2E8F0] shadow-civic-card space-y-5">
                ...
                <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                  ...
                  <span className="text-[11px] font-bold text-[#0B4F8A] bg-sky-50 px-2 py-0.5 rounded">
                    Merlo, Bs. As.
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  <div className="p-3.5 rounded-2xl bg-sky-50/70 border border-sky-100">
                    <div className="flex items-center justify-between text-[11px] text-[#0B4F8A] font-bold mb-1">
                  ...
                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200">
                    ...
                    <p className="text-[11px] text-slate-500 mt-0.5">Relevado por coordinadores barriales</p>
                  </div>
                </div>
                ...
                <div className="pt-2 border-t border-slate-100">
                  ...
                  >
                    <input
                      ...
                      className="flex-1 px-3 py-2 rounded-xl border border-slate-200 text-xs uppercase font-mono focus:outline-none focus:ring-2 focus:ring-sky-400"
                    />
                    <button
                      type="submit"
                      className="px-3.5 py-2 rounded-xl bg-[#0B4F8A] hover:bg-[#072C4F] text-white text-xs font-bold transition-colors"
                    >
                      Consultar
                    </button>
                  </form>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <Link
            ...
            className="group p-6 rounded-2xl bg-white border border-[#E2E8F0] hover:border-sky-300 shadow-civic-soft hover:shadow-civic-card transition-all duration-200 flex flex-col justify-between"
          >
            <div>
              <div className="w-12 h-12 rounded-xl bg-sky-50 text-[#0B4F8A] flex items-center justify-center mb-4 group-hover:scale-110 group-hover:bg-[#0B4F8A] group-hover:text-white transition-all">
                <PlusCircle className="w-6 h-6" />
              </div>
              <h3 className="text-base font-bold text-[#0F172A] group-hover:text-[#0B4F8A] transition-colors">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center gap-1 text-xs font-bold text-[#0B4F8A]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#E2E8F0] shadow-civic-soft space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <Link
              href="/mapa"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-sky-50 hover:bg-sky-100 text-[#0B4F8A] border border-sky-200 text-xs font-bold transition-colors self-start sm:self-auto"
            >
          ...
          {stats && stats.total > 0 ? (
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
              ...
              <div className="p-5 rounded-2xl bg-amber-50/60 border border-amber-200 space-y-2">
                ...
                <p className="text-[11px] text-amber-700">En evaluación comunitaria</p>
              </div>

              <div className="p-5 rounded-2xl bg-sky-50/60 border border-sky-200 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold text-[#0B4F8A]">Derivados</span>
                  <Send className="w-4 h-4 text-[#0B4F8A]" />
                </div>
                <div className="text-3xl font-black text-[#0B4F8A]">
                  {stats.derivados + stats.enSeguimiento}
                </div>
                <p className="text-[11px] text-sky-800">Canalizados con petitorios</p>
              </div>
            ...
            <div className="p-8 rounded-2xl bg-sky-50/40 border border-sky-100 text-center space-y-3">
              <Sparkles className="w-8 h-8 text-[#0B4F8A] mx-auto" />
              ...
              <Link
                href="/reclamos/nuevo"
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#0B4F8A] text-white text-xs font-bold"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <Link
            href="/reclamos"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-[#0B4F8A] hover:text-[#072C4F] group"
          >
        ...
        <div className="text-center pt-6">
          <Link
            href="/reclamos"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm text-[#0B4F8A] bg-white border border-sky-200 hover:bg-sky-50 shadow-sm transition-colors"
          >
            <span>Explorar los {recentComplaints.length} reportes en el directorio</span>
            <ArrowRight className="w-4 h-4 text-[#0B4F8A]" />
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] space-y-3 relative">
              <span className="w-8 h-8 rounded-full bg-[#0B4F8A] text-white font-bold text-sm flex items-center justify-center">
                1
              </span>
              <h3 className="text-base font-bold text-[#0F172A]">Carga del reclamo</h3>
            ...
            <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] space-y-3 relative">
              ...
              <h3 className="text-base font-bold text-[#0F172A]">Validación barrial</h3>
              <p className="text-xs text-[#64748B] leading-relaxed">
                La comunidad de coordinadores barriales constata la problemática y categoriza el impacto en el barrio.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] space-y-3 relative">
              ...
              <h3 className="text-base font-bold text-[#0F172A]">Gestión y petitorios</h3>
              <p className="text-xs text-[#64748B] leading-relaxed">
                Se organizan pedidos formales, petitorios comunitarios y seguimiento ciudadano directo.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] space-y-3 relative">
              ...
              <h3 className="text-base font-bold text-[#0F172A]">Trazabilidad pública</h3>
              <p className="text-xs text-[#64748B] leading-relaxed">
          ...
          <div className="text-center pt-2">
            <Link
              href="/como-funciona"
              className="inline-flex items-center gap-1 text-xs font-bold text-[#0B4F8A] hover:underline"
            >
      ...
      {/* 6. FINAL BANNER CTA */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#072C4F] via-[#0B4F8A] to-[#072C4F] text-white p-8 sm:p-12 shadow-xl">
          <div className="max-w-2xl space-y-4">
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              <Link
                href="/reclamos/nuevo"
                className="px-6 py-3 rounded-xl bg-white text-[#0B4F8A] font-bold text-sm hover:bg-sky-50 shadow-md transition-all hover:scale-105"
              >
                Reportar ahora
              </Link>
              <Link
                href="/mapa"
                className="px-6 py-3 rounded-xl bg-[#072C4F] border border-sky-400/40 text-white font-bold text-sm hover:bg-sky-950 transition-colors"
              >
